...
| App : expr -> expr -> expr
| Num : nat -> expr
(* | NumBinop : (nat -> nat -> nat) -> expr -> expr -> expr. *)
| Add : expr -> expr -> expr.
...
Fixpoint subst (from : var) (to : expr) (e : expr) : expr :=
  ...
  | Num n => Num n
  | Add e1 e2 => Add (subst from to e1) (subst from to e2)
  end.
...
Fixpoint is_free_var (e : expr) (y : var) : Prop :=
  ...
  | Num n => False
  | Add e1 e2 => is_free_var e1 y \/ is_free_var e2 y
